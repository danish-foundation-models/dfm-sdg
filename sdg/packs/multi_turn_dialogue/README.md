...
The Danish seed bank currently has 38 archetypes expanded to 304 seed specs by the default `variants_per_seed: 8`, covering all nine ConsistentChat top-level interaction types.
