...
from sdg.packs.synth.record_loader import load_record_source
from sdg.packs.synth.types import AssistantStyle, Record

DATA_DIR = Path(__file__).resolve().parent / "data"
PRESETS = {"starter": DATA_DIR / "starter_assistant_styles.yaml"}


def load_assistant_style(cfg: Record, *, family: str = "memorization") -> AssistantStyle:
