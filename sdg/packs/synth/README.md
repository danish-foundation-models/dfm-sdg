...
- grounded QA row generation from multi-source evidence with inline citations
...
- multilingual language planning across source, prompt, reasoning, and target fields
- verification and publication of memory-core artifacts and generated families

Not implemented yet:

- math, editing, creative, and dialogue generators
- teacher-model training
- local embedding and reranking support
- broader multi-document fact-bundle construction beyond the current memorization and grounded QA paths
