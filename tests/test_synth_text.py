...
from sdg.packs.synth.build_memory_core import build_index
from sdg.packs.synth.memorization_text import is_person, lexical_tokens, meaningful_tokens, tokenize
